...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="mx-auto flex w-full flex-col items-center bg-white pt-20 font-sans dark:bg-neutral-950 md:px-10"
      ref={containerRef}
    >
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="max-w-screen-md font-heading text-2xl md:text-4xl lg:text-[36px]">
          Every journey starts with a first step. Here’s how I help people go
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              ...
              <h3 className="hidden text-3xl font-bold text-neutral-500 dark:text-neutral-500 md:block md:pl-20 md:text-xl">
                {item.title}
              </h3>
            </div>
